...
HD_PWD='C:/Users/G731/OneDrive/Escritorio/Universidad/CUARTO/1er CUATRI/SED/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_LAVADORA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_LAVADORA.tcl -notrace
